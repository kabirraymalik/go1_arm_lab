...
class UniformPoseCommandCfg(CommandTermCfg):
    ...
    """   max curriculum iteration for the pose command, which is valid when enable_curriculum = True
    ...
    """Ranges for the commands,  which is valid when enable_curriculum = False."""

    ranges_init: Ranges = None
    """The initial range, which is valid when enable_curriculum = True."""

    ranges_final: Ranges = None
    """The maximum range, which is valid when enable_curriculum = True."""
...
class UniformVelocityCommandCfg(CommandTermCfg):
    ...
    ranges: Ranges = MISSING
    """Distribution ranges for the velocity commands, which is valid when enable_curriculum = False."""
    ...
    curriculum_coeff: float = 1.0
    """max curriculum iteration for the velocity command, which is valid when enable_curriculum = True.
    Optimal accuracy is achieved at num_env=4096, while other settings may lead to suboptimal results.
    check velocity_command.py for more details"""
